...
const CACHE_NAME = 'mafkoudin-dz-shell-v8';
const APP_SHELL = [
  BASE_PATH,
  `${BASE_PATH}index.html`,
  `${BASE_PATH}css/style.css`,
  `${BASE_PATH}js/main.js`,
  `${BASE_PATH}js/api-config.js?v=report-submit-v4`,
  `${BASE_PATH}js/main.js?v=report-submit-v4`,
  `${BASE_PATH}js/report-submission.js?v=report-submit-v4`,
  `${BASE_PATH}js/ads.js`,
